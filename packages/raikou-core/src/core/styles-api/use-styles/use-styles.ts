...
// import { useRaikouTheme, useRaikouClassNamesPrefix } from '../../RaikouProvider';
...
import { DEFAULT_THEME, defaultVariantColorsResolver } from '../../../core';
...
export function useStyles<Payload extends FactoryPayload>({
  ...
  // const classNamesPrefix = useRaikouClassNamesPrefix();
