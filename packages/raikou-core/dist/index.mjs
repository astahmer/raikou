...
import { css, cx as cx3 } from "@raikou/styled-system/css";
...
var Badge = polymorphicFactory((_props, ref) => {
  ...
  const rootStyles = css(styles == null ? void 0 : styles.root);
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(StyledElement, __spreadProps(__spreadValues(__spreadValues({ ref, className: cx3(rootStyles) }, getStyles("root", { variant })), others), { children: [
    leftSection && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: badgeSection(), "data-position": "left", children: leftSection }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: badgeLabel(), children }),
    rightSection && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: badgeSection(), "data-position": "right", children: rightSection })
  ] }));
});
...
export {
  ...
  createVarsResolver,
  darken,
  defaultVariantColorsResolver2 as defaultVariantColorsResolver,
  em,
  factory,
  filterProps,
  getFontSize,
