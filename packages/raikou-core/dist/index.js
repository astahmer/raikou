...
__export(src_exports, {
  ...
  darken: () => darken,
  defaultVariantColorsResolver: () => defaultVariantColorsResolver2,
  em: () => em,
  factory: () => factory,
...
function getStyle({
  ...
  return __spreadValues({}, resolveVars({ theme, props, stylesCtx, vars, varsResolver: varsResolver2, selector, themeName }));
}
...
function parseThemeColor({
  ...
  if (typeof color !== "string") {
    throw new Error(`[@raikou/core] Failed to parse color. Instead got ${typeof color}`);
  }
...
function useProps(defaultProps2, props) {
  return __spreadValues(__spreadValues({}, defaultProps2), filterProps(props));
}
...
function polymorphicFactory(ui) {
  const Component = (0, import_react2.forwardRef)(ui);
  Component.extend = identity;
  return Component;
}
...
var _Box = (0, import_react3.forwardRef)(
  (_a, ref) => {
    var _b = _a, { component, style, className, variant, mod, size } = _b, others = __objRest(_b, ["component", "style", "className", "variant", "mod", "size"]);
    const Element = component || "div";
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Element, __spreadValues({ ref, className, style: __spreadValues({}, style) }, others));
  }
);
...
var import_css = require("@raikou/styled-system/css");
var import_jsx = require("@raikou/styled-system/jsx");
var import_recipes = require("@raikou/styled-system/recipes");
...
var Badge = polymorphicFactory((_props, ref) => {
  ...
  const StyledElement = (0, import_jsx.styled)("badge", (0, import_recipes.badgeRoot)());
  const rootStyles = (0, import_css.css)(styles == null ? void 0 : styles.root);
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(StyledElement, __spreadProps(__spreadValues(__spreadValues({ ref, className: (0, import_css.cx)(rootStyles) }, getStyles("root", { variant })), others), { children: [
    leftSection && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: (0, import_recipes.badgeSection)(), "data-position": "left", children: leftSection }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: (0, import_recipes.badgeLabel)(), children }),
    rightSection && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: (0, import_recipes.badgeSection)(), "data-position": "right", children: rightSection })
  ] }));
});
